...
class SpiderFootPlugin():
    ...
    def warn(self, *args, **kwargs) -> None:
        ...
        Args:
            *args: passed through to logging.warn()
            *kwargs: passed through to logging.warn()
        """
        self.log.warn(*args, extra={'scanId': self.__scanId__}, **kwargs)
